...
class DDPG(OffPolicyRLAlgorithm):
    ...
    Args:
        ...
        policy (meta_agents.policies.base.Policy): Policy.
        target_policy (meta_agents.policies.base.Policy): Copy of policy.
        qf (object): Q-value network.
        target_qf (object): Copy of Q-value network.
        replay_buffer (meta_agents.replay_buffer.ReplayBuffer): Replay buffer.
        ...
        exploration_strategy (meta_agents.np.exploration_strategies.
